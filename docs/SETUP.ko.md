...
애플워치나 아이폰을 Mac에 직접 연결할 필요는 없습니다. 운동 기록이 인터넷을 통해 Apple 건강과 Strava에 도착해야 합니다.
...
`doctor`에서 Python, Strava, Garmin, 비공개 폴더가 모두 `true`여야 합니다. Nike–Garmin 연결은 수동 확인 항목으로 표시됩니다.
